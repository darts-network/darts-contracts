...
import type {
  IHiveStorage,
  IHiveStorageInterface,
} from "../../contracts/IHiveStorage";
...
export class IHiveStorage__factory {
  static readonly abi = _abi;
  static createInterface(): IHiveStorageInterface {
    return new Interface(_abi) as IHiveStorageInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IHiveStorage {
    return new Contract(address, _abi, runner) as unknown as IHiveStorage;
  }
}
