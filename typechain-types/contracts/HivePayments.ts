...
export interface HivePaymentsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptResult"
      | "addResult"
...
export interface HivePayments extends BaseContract {
  connect(runner?: ContractRunner | null): HivePayments;
  waitForDeployment(): Promise<this>;

  interface: HivePaymentsInterface;
