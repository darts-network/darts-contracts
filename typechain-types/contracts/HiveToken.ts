...
export interface HiveTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface HiveToken extends BaseContract {
  connect(runner?: ContractRunner | null): HiveToken;
  waitForDeployment(): Promise<this>;

  interface: HiveTokenInterface;
