...
export interface HiveStorageInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptResult"
      | "addResult"
...
export interface HiveStorage extends BaseContract {
  connect(runner?: ContractRunner | null): HiveStorage;
  waitForDeployment(): Promise<this>;

  interface: HiveStorageInterface;
